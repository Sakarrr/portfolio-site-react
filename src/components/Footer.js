...
const linkedin = <svg xmlns="http://www.w3.org/2000/svg" width="54" height="55" viewBox="0 0 54 55" fill="none">
    <path
...
const twitter = <svg xmlns="http://www.w3.org/2000/svg" width="54" height="55" viewBox="0 0 54 55" fill="none">
    <path
            ...
            <div className="container">
                <div className="footer-content">
                    ...
                    <div className="footer-social">
                        ...
                        <a href="https://www.linkedin.com/in/sakarshrestha97/" target="_blank" rel="noreferrer">
                            <span>
                                <div className={"social-icon"}> {linkedin} LinkedIn.com </div>  {arrow}
                            </span>
                        </a>
                        <a href="https://twitter.com/sakarrstha" target="_blank" rel="noreferrer">
                            <span>
